    ...
    <main class="form-signin">
        <form class="form-signup" action="signup.inc.php" method="POST">
            ...
            <section class="signup-form">
                ...
                <div class="form-floating">
                    <input type="text" class="form-control" id="nameNick" placeholder="Nick name (optional)" />
                    <label for="email">Nick Name (optional)</label>
                </div>
                <div class="form-floating">
                ...
                <div class="form-floating">
                    <input type="text" class="form-control" id="nameUser" placeholder="User name" />
